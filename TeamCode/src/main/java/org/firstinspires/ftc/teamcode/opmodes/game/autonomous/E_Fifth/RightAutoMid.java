...
public abstract class RightAutoMid extends AutoControls {
    ...
    public void startAuto() {
        ...
        //Drive to stack
        performAction(24.75, 270, 5.5, 11, coneOneGrabHeight, 24, -1, 0, Robot.grabberServoHalfwayPos, 24, .5, 0, true, new double[]{-1, 0}, 0);
        ...
        // Go to pole + drop
        performAction(-36, 272, 6.5, 10, Robot.liftJunctionMediumHeight, 38, Robot.turretRightDegrees, 20, Robot.grabberServoOpenPos, 0, 0, 0, false, new double[]{-1, 0}, 0);
        sleep(250);
