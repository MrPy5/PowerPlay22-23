...
public abstract class RightAutoHigh extends AutoControls {
    ...
    public void startAuto() {
        ...
        performAction(43, 0, 7, 9, Robot.liftJunctionMediumHeight, 37, Robot.turretLeftDegrees, 22, Robot.grabberServoOpenPos, 0, 0, 0, false);
        sleep(250);
        performAction(9.5, 0, 3, 9, -1, 0, Robot.turretForwardDegrees, 14, -1, 0, 0, 0, false);

        //Turn
        //performAction(0, 267, 7, 0, -1, 0, -1, 0, -1, 0, 0, 0);
        //Drive to stack
        performAction(24.75, 266, 5.5, 11, coneOneGrabHeight, 24, -1, 0, Robot.grabberServoHalfwayPos, 24, .5, 0, true);
        ...
        //drive to stack
        performAction(36, 267, 6.5, 8, coneTwoGrabHeight, 30, Robot.turretForwardDegrees, 35, Robot.grabberServoHalfwayPos, 20, 0, 0, true);
        ...
        //Drive to stack
        performAction(36, 267, 6.5, 8, coneThreeGrabHeight, 30, Robot.turretForwardDegrees, 35, Robot.grabberServoHalfwayPos, 20, 0, 0, true);
        ...
        //Drive to stack
        performAction(36, 267, 6.5, 8, coneFourGrabHeight, 30, Robot.turretForwardDegrees, 35, Robot.grabberServoHalfwayPos, 20, 0, 0, true);
        ...
        if (endParkingPosition == 3) {
            ZeroPowerToFloat();
            performAction(31.5, 270, 6, 11, Robot.liftJunctionGroundHeight, 25, Robot.turretForwardDegrees, 40, -1, -1, 1, 0, false);
        }
