...
public class LeftAuto extends AutoControls {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        performAction(41, 0, 6.5, 9, Robot.liftJunctionMediumHeight, 37, Robot.turretRightDegrees, 22, Robot.grabberServoOpenPos, 0, 0, 0, false);
        sleep(250);
        ...
        //Drive to stack
        performAction(24.25, 87, 5, 11, coneOneGrabHeight, 24, -1, 0, Robot.grabberServoHalfwayPos, 24, .5, 0, true);
        ...
        // Go to pole + drop
        performAction(-34.5, 88, 6.5, 9, Robot.liftJunctionMediumHeight, 38, Robot.turretLeftDegrees, 20, Robot.grabberServoOpenPos, 0, 0, 0, false);
        sleep(250);

        //drive to stack
        performAction(36, 87, 6.5, 8, coneTwoGrabHeight, 30, Robot.turretForwardDegrees, 35, Robot.grabberServoHalfwayPos, 20, 0, 0, true);
        ...
        //Drive to stack
        performAction(36, 87, 6.5, 8, coneThreeGrabHeight, 30, Robot.turretForwardDegrees, 35, Robot.grabberServoHalfwayPos, 20, 0, 0, true);
        ...
        if (endParkingPosition == 2) {
            performAction(8.5, 90, 5, 20, -1, 0, Robot.turretForwardDegrees, 8.5, -1, -1, 1, 0, false);
