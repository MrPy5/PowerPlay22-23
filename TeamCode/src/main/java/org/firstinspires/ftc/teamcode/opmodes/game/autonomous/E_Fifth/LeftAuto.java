...
public abstract class LeftAuto extends AutoControls {
    ...
    public void startAuto() {
        ...
        performAction(16.25, 0, 4, 8, Robot.liftJunctionLowHeight, 12, Robot.turretRightDegrees, 14, Robot.grabberServoOpenPos, 0, 0.1, 0, false, new double[] {1, 1, Robot.cURightOpenPos});
        ...
        performAction(37.25, 0, 6.5, 9, Robot.liftJunctionMediumHeight, 47, Robot.turretForwardDegrees, 12, -1, 0, 0, 0, false, new double[] {34, 1, Robot.cURightClosedPos});



        performAction(25, 88, 5.5, 11, coneOneGrabHeight, 24, -1, 1, Robot.grabberServoHalfwayPos, 24, 0, 0, true, new double[] {-1, 0, 0});
        ...
        // Go to pole + drop
        performAction(-nextDrive, 88, 7, 11, Robot.liftJunctionMediumHeight, 38, Robot.turretLeftDegrees, 20, Robot.grabberServoOpenPos, 0, 0, 0, false, new double[] {-1, 0, 0});
        //sleep(100);

        //drive to stack
        performAction(34.75, 88, 7, 11, coneTwoGrabHeight, 30, Robot.turretForwardDegrees, 35, Robot.grabberServoHalfwayPos, 20, 0, 0, true, new double[] {-1, 0, 0});
        ...
        //Drive to stack
        performAction(34.75, 88, 7, 11, coneThreeGrabHeight, 30, Robot.turretForwardDegrees, 35, Robot.grabberServoHalfwayPos, 20, 0, 0, true, new double[] {-1, 0, 0});
        ...
        if (gameTimer.milliseconds() < lastConeQuitTime) {
            //Drive to stack
            performAction(34.75, 88, 7, 11, coneFourGrabHeight, 30, Robot.turretForwardDegrees, 35, Robot.grabberServoHalfwayPos, 20, 0, 0, true, new double[] {-1, 0, 0});
        ...
        if (gameTimer.milliseconds() < lastConeQuitTime) {
            //Drive to stack
            performAction(34.75, 88, 7, 11, coneFiveGrabHeight, 30, Robot.turretForwardDegrees, 35, Robot.grabberServoHalfwayPos, 20, 0, 0, true, new double[] {-1, 0, 0});
        ...
        if (endParkingPosition == 2) {
            performAction(9.25, 90, 4, 15, -1, 0, Robot.turretForwardDegrees, 8.5, -1, -1, 0, 0.5, false, new double[] {-1, 0, 0});
        ...
        if (endParkingPosition == 3) {
            performAction(-16, 90, 4, 20, -1, 0, Robot.turretForwardDegrees, 13, -1, -1, 1, 0.5, false, new double[] {-1, 0, 0});
