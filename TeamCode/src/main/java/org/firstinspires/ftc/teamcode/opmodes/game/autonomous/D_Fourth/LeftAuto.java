...
public class LeftAuto extends AutoControls {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        // Go to pole + drop
        performAction(-34, 87, 6.5, 9, Robot.liftJunctionMediumHeight, 38, Robot.turretLeftDegrees, 20, Robot.grabberServoOpenPos, 0, 0, 0);
        sleep(250);
        ...
        //Go to pole + drop
        performAction(-34.75, 87, 6.5, 9, Robot.liftJunctionMediumHeight, 38, Robot.turretLeftDegrees, 20, Robot.grabberServoOpenPos, 0, 0, 0);
        sleep(250);
        ...
        if (endParkingPosition == 2) {
            performAction(8.5, 90, 5, 20, Robot.liftJunctionGroundHeight, 13, Robot.turretForwardDegrees, 13, -1, -1, 1, 0);
        }
        if (endParkingPosition == 3) {
            performAction(-14.5, 90, 5, 20, Robot.liftJunctionGroundHeight, 13, Robot.turretForwardDegrees, 13, -1, -1, 1, 0);
        }
